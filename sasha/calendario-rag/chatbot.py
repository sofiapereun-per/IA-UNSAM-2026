...
def partir_en_entradas(texto):
    ...
    El calendario entero tiene ~437 palabras: si cortáramos en ventanas de 120
    quedarían 4 fragmentos y traer 3 sería traer casi todo. Una entrada por
    fragmento da 37 y ahí sí se ve la búsqueda eligiendo. El mes va adelante
    para que el fragmento se entienda solo: "Julio — 21 al 27 de julio —
    Receso invernal".
    """
    fragmentos = []
    mes = None
